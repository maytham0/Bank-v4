...
private:
    enum enTransactionsMenueOptions {
        ...
        eShowTotalBalance = 3,eTransferScreen=4,eShowLogTransfer=5,eShowMainMenue = 6
    };
    ...
    static void _ShowLogTransfer()
    {
        //cout << "\nLog transfer will be here.\n";
        clsTransferScreen::ShowLogTransfer();
    }
    ...
    static void _PerformTransactionsMenueOption(enTransactionsMenueOptions TransactionsMenueOption)
    {
        ...
        case enTransactionsMenueOptions::eShowLogTransfer:
        {
            system("cls");
            _ShowLogTransfer();
            _GoBackToTransactionsMenue();
